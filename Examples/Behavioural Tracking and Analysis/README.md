...
The higher-order observable sequence generated by the `CreateObservable` node is concatenated again and added into a list, which gets concatenated again outside of the `SelectMany` node.
