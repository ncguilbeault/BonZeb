...
namespace Bonsai.TailTracking
{
    ...
    public class CalculateCentroid : Transform<BackgroundSubtractionData, CentroidData>
    {
        ...
        private CentroidTrackingMethod centroidTrackingMethod;
        [Description("The method for performing centroid tracking.")]
        public CentroidTrackingMethod CentroidTrackingMethod { get => centroidTrackingMethod; set => centroidTrackingMethod = value; }
